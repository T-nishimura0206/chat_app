    ...
    <div class="height-100" style=background-color:#f0f0f0;">
        ...
        @if (!empty($members))
            @foreach ($members as $member) 
                <div class="chat-item card mb-0 border-top-0 border-start-0 border-end-0 rounded-0" data-chat-id="{{ $member['chat_id'] }}">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-7 ms-5">
                                <h5 class="card-title" style="border:none;">{{ $member['user']['name'] }}</h5>
                                <p class="card-text" style="">{{ $member['latest_message']['message'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
